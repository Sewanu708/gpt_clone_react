...
function ModelOutput({ modelResponse, loading, agent, id }: { modelResponse: { text: string, createdAt: number }, loading: boolean, agent: string, id: string }) {
    ...
    return (
        <div
            className=" md:w-[70%] w-fit flex flex-col gap-2 items-start justify-start relative"
        >
